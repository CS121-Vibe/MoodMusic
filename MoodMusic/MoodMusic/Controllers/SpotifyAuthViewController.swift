...
//  MoodMusic
//
//  Created by Omari Matthews on 11/4/19.
//  Copyright © 2019 Vibe. All rights reserved.
//

import UIKit

class SpotifyAuthViewController: UIViewController, SPTSessionManagerDelegate, SPTAppRemoteDelegate, SPTAppRemotePlayerStateDelegate {
